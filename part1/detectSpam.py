...
if __name__ == '__main__':
	...
	for word, val in nsmallest(10, spamWords.iteritems(), key=lambda (k, v): (-v, k)):
		ctr1 += 1
		print ctr1, '.', word
	print ''
	print 'Top ten words least associated with not spam:'
	for word, val in nsmallest(10, nonSpamWords.iteritems(), key=lambda (k, v): (-v, k)):
		ctr2 += 1
		print ctr2, '.', word
	...
	print ''
	print 'Top ten words associated with spam:'
	for word, val in nsmallest(10, binarySpam.iteritems(), key=lambda (k, v): (-v, k)):
		bctr1 += 1
		print bctr1, '.', word
	print ''
	print 'Top ten words least associated with not spam:'
	for word, val in nsmallest(10, binaryNonSpam.iteritems(), key=lambda (k, v): (-v, k)):
		bctr2 += 1
		print bctr2, '.', word
